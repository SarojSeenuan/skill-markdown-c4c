...
<nav class="toc">
  <h2>Index</h2>
  <ol>
    <li><a href="#sec-1">セクション名</a><span class="dots"></span><span class="page">3</span></li>
    <li><a href="#sec-2">セクション名</a><span class="dots"></span><span class="page">7</span></li>
  </ol>
</nav>
```
...
TOC 側:
```html
<li><a href="#sec-tables">テーブル</a><span class="dots"></span><span class="page">5</span></li>
```
