...
<div class="caption">Author: Saroj Seenuan (Ken)　·　Version: v1.0　·　Date: 2026-05-21　·　株式会社C4C</div>
...
<p class="center muted">— END OF ARTICLE —</p>

<p class="center"><span class="tag">v1.0</span> <span class="tag">2026-05-21</span> <span class="tag">株式会社C4C</span></p>
